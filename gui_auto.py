...
def main() -> None:
    ...
    images_to_search: List[str] = sys.argv[1:] or ["accept_green.png", "accept_green-2.png", "accept_green-3.png", "accept_green-4.png","accept_green-5.png","Codex_wants_to_run.png"]
